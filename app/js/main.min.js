...
$((function(){$(".category__slider-typeFood").slick({slidesToShow:1,slidesToScroll:1,arrows:!0,dots:!0,autoplay:!1,prevArrow:'<button type="button" class="slick-prev"><svg class="svg-roundarrow-left-dims"><use xlink:href="../images/sprite.svg#roundarrow-left"></svg></button>',nextArrow:'<button type="button" class="slick-next"><svg class="svg-roundarrow-right-dims"><use xlink:href="../images/sprite.svg#roundarrow-right"></svg></button>'})}));let categories=document.querySelectorAll(".category__buttons-item"),sliders=document.querySelectorAll(".category__slider-typeFood");for(const t of categories)t.addEventListener("click",(function(){for(const t of categories)t.classList.remove("category__buttons-item--active");this.classList.add("category__buttons-item--active"),console.log(sliders);for(const t of sliders)t.classList.remove("category__slider-typeFood--active");sliders[t.dataset.category].classList.add("category__slider-typeFood--active")}));