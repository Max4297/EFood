...
$((function(){$(".header__btn-menu").on("click",(function(){$(".menu").toggleClass("menu--open")})),$(".category__slider-typeFood").slick({slidesToShow:1,slidesToScroll:1,arrows:!0,dots:!0,autoplay:!1,prevArrow:'<button type="button" class="category__slick-prev"><svg class="category__slider-leftArrow"><use xlink:href="../images/sprite.svg#roundarrow-left"></svg></button>',nextArrow:'<button type="button" class="category__slick-next"><svg class="category__slider-rightArrow"><use xlink:href="../images/sprite.svg#roundarrow-right"></svg></button>'}),$(".reviews__items").slick({slidesToShow:1,slidesToScroll:1,arrows:!0,dots:!1,autoplay:!1,draggable:!1,prevArrow:'<button type="button" class="reviews__slick-prev"><svg class="reviews__slider-rightArrow"><use xlink:href="../images/sprite.svg#reviews-arrow-left-icon"></svg></button>',nextArrow:'<button type="button" class="reviews__slick-next"><svg class="reviews__slider-rightArrow"><use xlink:href="../images/sprite.svg#reviews-arrow-right-icon"></svg></button>'})}));let categories=document.querySelectorAll(".category__buttons-item"),sliders=document.querySelectorAll(".category__slider-typeFood");for(const e of categories)e.addEventListener("click",(function(){for(const e of categories)e.classList.remove("category__buttons-item--active");this.classList.add("category__buttons-item--active"),console.log(sliders);for(const e of sliders)e.classList.remove("category__slider-typeFood--active");sliders[e.dataset.category].classList.add("category__slider-typeFood--active")}));